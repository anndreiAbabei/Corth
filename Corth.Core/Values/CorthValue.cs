...
public abstract class CorthValue
{
    ...
    internal TValue ConvertValue<TValue>(string expectedType)
    ...
    protected CorthValue InvalidOperation([CallerMemberName] string operation = "") =>
        throw new CorthRuntimeOperationInvalidTypeException(Type, operation);
}